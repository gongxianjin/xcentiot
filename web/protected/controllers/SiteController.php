...
class SiteController extends Controller
{
	...
	{
		#推荐产品
		$bestproduct = Faq::model()->findAll('csc_cate_id=:cid  AND csc_best=1 order by csc_sort DESC limit 4',array('cid'=>'2'));
		$this->keywords = Yii::app()->params['site']['keyword'];
//		dump($bestproduct);die;
