 ...
 */
class User extends SubCActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('csc_id, csc_type, csc_reg_time, csc_reg_ip', 'required'),
			...
			array('csc_id, csc_username, csc_phone, csc_email, csc_tname, csc_nichen, csc_pwd, csc_type, csc_login_time, csc_login_ip, csc_lock, csc_reg_time, csc_reg_ip, csc_sex, csc_header, csc_age, csc_jobs, csc_company, csc_education, csc_primary, csc_middle, csc_college, csc_address', 'safe', 'on'=>'search'),
		);
	}
